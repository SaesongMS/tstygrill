...
<body>
    <div class="bg-white shadow-md" x-data="{ isOpen: false }">
        <div class="fixed top-0 right-0 px-6 py-10 sm:block">
            @auth
        ...
        <nav class="container px-6 py-8 mx-auto md:flex md:justify-between md:items-center">
            ...
            <div :class="isOpen ? 'flex' : 'hidden'"
                ...
                <a class="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500 hover:text-green-400"
                    href="{{ route('menus.index') }}">Nasze Menu</a>
                    <a class="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500 hover:text-green-400"
                    href="{{ route('gallery.index') }}">Galeria</a>
                <a class="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500 hover:text-green-400"
                    href="{{ route('reservations.step.one') }}">Zamów stolik</a>
        ...
        <div class="container flex flex-wrap items-center justify-center px-4 py-8 mx-auto lg:justify-between">
            <div class="flex flex-wrap justify-center">
                <ul class="flex items-center space-x-4 text-white">
                    <li>&copy; Copyright <strong><span>PsznyGryl</span></strong>.</li>
                </ul>
            </div>
            <div class="flex justify-center mt-4 lg:mt-0">
                <a href="https://www.facebook.com/Biuro-Interwencji-Obywatelskich-323685178145183/">
                    <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        class="w-6 h-6 text-blue-600" viewBox="0 0 24 24">
                        <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                    </svg>
                </a>
                <a class="ml-3" href="https://twitter.com/majakstasko">
                    <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a class="ml-3" href="https://www.instagram.com/firmaremonty/">
